...
export default function VideoGallery() {
  ...
  const currentVid = videos[activeIndex] || videos[0];
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16 flex flex-col items-center">
          ...
          <p className="font-rounded font-medium text-brand-green/70 text-sm mt-3 leading-relaxed">
            Unschooling goes beyond Kishangarh. Watch these world-renowned educational documentaries and video features that explain the core logic of our daily experiential learning methodology.
          </p>
        </div>
              ...
              <div className="relative aspect-video w-full bg-black border-b-2 border-brand-green overflow-hidden">
                <AnimatePresence mode="wait">
                  {!isPlaying ? (
                    ...
                    >
                      <iframe
                        src={`https://www.youtube.com/embed/${currentVid.youtubeId}?autoplay=1&mute=0`}
